...
if __name__ == '__main__':
    ...
    for i, m in enumerate(m_arr):
        ...
        plt.plot(eps_c_arr, load_arr, label='m='+str(m)+',sV0='+str(sV0)+',tau_shape='+str(shape)+',tau_scale='+str(scale))
...
#     position_arr = np.array([4.294751, 18.077906, 30.562648, 50.538234, 69.614919, 80.801248    95.18367    111.363895
# 77.504329    48.934329    106.05434    61.116677    65.234314    81.524416    59.144938    118.236748
# 8.9305    6.7392    11.4092    7.6606    7.9895    9.2646    7.5986    12.2346
