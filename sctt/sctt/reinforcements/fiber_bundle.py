...
if __name__ == '__main__':
    ...
    reinf = FiberBundle(r=0.0035,
                        tau=np.array([ 0.02680217,  0.03862634,  0.04707699,  0.0542814 ,  0.06082189, 0.06697246,  0.07289507,  0.07870153,  0.08447959,  0.0903067, 0.09625907,  0.10241951,  0.10888651,  0.11578704,  0.1232982, 0.13168872,  0.14141016,  0.15333842,  0.16964278,  0.20090774]),
                        tau_weights = np.array([0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]),
                        V_f=0.1,
                        E_f=200e3,
                        xi=0.035)
