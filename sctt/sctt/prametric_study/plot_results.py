...
s = np.linspace(2.4, 3.8, 100)
m = np.linspace(10, 100, 100)

cs = smooth_cs(s, m)

filename = 'D:\\data\\Tensile_test_multiple_cracking\\1.0\\lof_avg.txt'
...
im = plt.imshow(lack_of_fit, interpolation='bilinear', origin='lower',
                cmap=cm.gray_r, extent=(2.4, 3.8, 10, 100), aspect=1.4 / 90.)
...
cs2 = plt.contour(cs, csme,
                  linewidths=3,
                  colors='k',
                  extent=(2.4, 3.8, 10, 100), origin='lower')
# plt.clabel(cs2, csme,
#            inline=1,
#            fmt='%1.1f',
#            fontsize=12)
